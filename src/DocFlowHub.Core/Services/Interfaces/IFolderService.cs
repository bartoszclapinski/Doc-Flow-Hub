...
public interface IFolderService
{
    ...
    Task<ServiceResult<FolderDto>> GetFolderByIdAsync(int id, string userId);
    ...
    Task<ServiceResult<PagedResult<FolderDto>>> GetFoldersInProjectAsync(int projectId, string userId, FolderFilter filter);
    ...
    Task<ServiceResult<IEnumerable<FolderDto>>> GetFolderPathAsync(int folderId, string userId);
    ...
    Task<ServiceResult> ArchiveFolderAsync(int folderId, string userId);
    Task<ServiceResult> RestoreFolderAsync(int folderId, string userId);
